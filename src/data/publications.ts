...
export const publications: Publication[] = [
  {
    ...
    titleZh: 'Qwen-CUA: Native Computer Use for (almost) Everything',
    authors: [
      'Dunjie Lu',
      'Shuai Bai',
      'Tianyi Bai',
  ...
  },
  {
    ...
    titleZh: 'EvoCUA-1.5: Online Reinforcement Learning for Multi-turn Computer-Use Agents',
    authors: [
      'Mianqiu Huang',
      'Taofeng Xue',
      'Chong Peng',
  ...
  },
  {
    ...
    titleZh: 'WebChain: A Large-Scale Human-Annotated Dataset of Real-World Web Interaction Traces',
  ...
  },
  {
    ...
    titleZh: 'WebFactory: Automated Compression of Foundational Language Intelligence into Grounded Web Agents',
    authors: [
      'Sicheng Fan',
      'Qingyun Shi',
      'Shengze Xu',
